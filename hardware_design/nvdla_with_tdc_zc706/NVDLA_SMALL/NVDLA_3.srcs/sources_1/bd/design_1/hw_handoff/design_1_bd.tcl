...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net smartconnect_1_M01_AXI [get_bd_intf_pins smartconnect_1/M01_AXI] [get_bd_intf_pins tdc_bank_0/S_AXI]

  # Create port connections
  connect_bd_net -net NV_nvdla_wrapper_0_dla_intr [get_bd_pins NV_nvdla_wrapper_0/dla_intr] [get_bd_pins ila_0/probe0] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins NV_nvdla_wrapper_0/core_clk] [get_bd_pins NV_nvdla_wrapper_0/csb_clk] [get_bd_pins axi_apb_bridge_0/s_axi_aclk] [get_bd_pins ila_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_10M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins tdc_bank_0/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins tdc_bank_0/clock_i] [get_bd_pins tdc_bank_0/delta_i]
  ...
  connect_bd_net -net rst_ps7_0_10M_peripheral_aresetn [get_bd_pins NV_nvdla_wrapper_0/csb_rstn] [get_bd_pins NV_nvdla_wrapper_0/rstn] [get_bd_pins axi_apb_bridge_0/s_axi_aresetn] [get_bd_pins rst_ps7_0_10M/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn] [get_bd_pins tdc_bank_0/s_axi_aresetn]
  connect_bd_net -net tdc_bank_0_data_o [get_bd_pins ila_0/probe1] [get_bd_pins tdc_bank_0/data_o]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs NV_nvdla_wrapper_0/s_apb/reg] SEG_NV_nvdla_wrapper_0_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs tdc_bank_0/S_AXI/S_AXI_reg] SEG_tdc_bank_0_S_AXI_reg
